...
namespace Typst.Renderer.WinUI.Tests;
...
public sealed class WinUiViewTests
{
    ...
    {
        var contract = typeof(ITypstDocumentView);
        var implementation = typeof(TypstView);
        ...
        Assert.NotNull(implementation.GetMethod(nameof(TypstView.SetDocumentAsync)));
    ...
    {
        var view = typeof(TypstView);
        Assert.NotNull(view.GetField(nameof(TypstView.DocumentProperty)));
        Assert.NotNull(view.GetField(nameof(TypstView.ZoomProperty)));
        Assert.NotNull(view.GetField(nameof(TypstView.ZoomModeProperty)));
        Assert.NotNull(view.GetField(nameof(TypstView.ViewModeProperty)));
        Assert.NotNull(view.GetField(nameof(TypstView.PageSpacingProperty)));
    }
