...
public sealed class TypstViewport : Grid, IDisposable
{
    private const double DocumentMargin = 28;
    private readonly Border _workspace;
    private readonly ScrollViewer _scrollViewer;
    private readonly TypstViewportInteractionController _interaction;
    private TypstViewportOffset? _pendingZoomOffset;
    ...
    public TypstViewport()
    {
        ...
        _interaction = new TypstViewportInteractionController(View);
        Background = Brushes.Transparent;
    ...
    private void ZoomWithWheel(object? sender, PointerWheelEventArgs args)
    {
        ...
        var point = args.GetPosition(_scrollViewer);
        var currentOffset = _pendingZoomOffset ?? new TypstViewportOffset(Offset.X, Offset.Y);
