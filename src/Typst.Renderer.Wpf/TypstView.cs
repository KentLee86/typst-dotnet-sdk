...
namespace Typst.Renderer.Wpf;

/// <summary>
/// WPF drawing adapter for the framework-neutral <see cref="TypstDocumentViewController"/>.
/// Place the view inside a <see cref="System.Windows.Controls.ScrollViewer"/> for scrolling.
/// </summary>
public sealed class TypstView : FrameworkElement, ITypstDocumentView, IDisposable
{
    public static readonly DependencyProperty DocumentProperty = DependencyProperty.Register(
        nameof(Document), typeof(TypstRenderedDocument), typeof(TypstView),
        new FrameworkPropertyMetadata(default(TypstRenderedDocument), OnDocumentChanged));

    public static readonly DependencyProperty ZoomProperty = DependencyProperty.Register(
        nameof(Zoom), typeof(double), typeof(TypstView),
        new FrameworkPropertyMetadata(TypstDocumentViewController.DefaultZoom, OnZoomChanged));
    ...
    public static readonly DependencyProperty PageSpacingProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(TypstDocumentViewController.DefaultPageSpacing, OnPageSpacingChanged));
    ...
    public static readonly DependencyProperty ZoomModeProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(TypstZoomMode.Custom, OnZoomModeChanged));

    public static readonly DependencyProperty ViewModeProperty = DependencyProperty.Register(
        nameof(ViewMode), typeof(TypstPageViewMode), typeof(TypstView),
        new FrameworkPropertyMetadata(TypstPageViewMode.ContinuousSingle, OnViewModeChanged));

    private readonly TypstDocumentViewController _controller = new();
    private readonly Dictionary<int, BitmapSource> _bitmaps = [];
    private TypstRenderedDocument? _bitmapDocument;
    ...
    private void RefreshBitmaps()
    {
        ...
        foreach (var pageIndex in desired.Where(index => !_bitmaps.ContainsKey(index)))
            _bitmaps.Add(pageIndex, TypstBitmapSource.Create(Document.Pages[pageIndex]));
        InvalidateVisual();
    }
